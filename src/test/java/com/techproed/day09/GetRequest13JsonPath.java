...
11. Çalışan bilgilerinin
 ...
 “id”:”11”
    ...
    public void test() {
        ...
        Assert.assertEquals(expectedDataMap.get("sondanIkinciCalisan"),json.getInt("data[-2].employee_salary"));
        Assert.assertTrue(json.getList("data.employee_age").containsAll((Collection<?>) expectedDataMap.get("arananYaslari")));
