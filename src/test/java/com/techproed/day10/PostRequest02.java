...
public class PostRequest02 extends HerokuAppTestBase {
    ...
    // "totalprice": 11111,
    // "depositpaid": true,
    // "bookingdates": { "checkin": "2020-09-09", "checkout": "2020-09-21"
    // }
    // }
    ...
    public void test(){
        ...
        Assert.assertEquals(expectedRequestData.getJSONObject("bookingdates").get("checkin"),json.getString("booking.bookingdates.checkin"));
        Assert.assertEquals(expectedRequestData.getJSONObject("bookingdates").get("checkout"),json.getString("booking.bookingdates.checkout"));
